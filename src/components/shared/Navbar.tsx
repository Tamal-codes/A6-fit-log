    ...
    return (
       <div className="navbar sticky top-0 z-50 bg-base-100 shadow-sm">
            ...
            <div className="navbar-end flex items-center gap-4">
                <Link
                    href="/my-plan"
                    className="flex items-center gap-2 bg-[#ccff00] text-black px-4 py-1.5 rounded-full font-semibold"     >
                    <span>Plan</span>
                ...
                <Link
                    href="/my-plan"
                    className="flex items-center gap-2 border border-gray-400 text-white px-4 py-1.5 rounded-full font-semibold"
                >
                    <span>Saved</span>

                    <span className="border border-gray-400 text-xs px-2 py-0.5 rounded-full">
                        {saved.length}
                    </span>
                </Link>
            </div>
